...
class CategoryViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, UISearchResultsUpdating {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.performSegue(withIdentifier: "segueToCategoriesDetailViewController", sender: categories)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "segueToCategoriesDetailViewController" {
//            if let destinationVC = segue.destination as? BLCategoriesDetailViewController {
//                destinationVC.currentCategories = sender as? SKCategory
//            }
        }
    }
